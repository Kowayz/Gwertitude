...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; outline: none; transition: 0.3s; }
        body { font-family: 'Crimson Text', serif; background-color: var(--bg-body); background-image: linear-gradient(45deg, rgba(212,175,55,0.008) 0%, transparent 50%, rgba(212,175,55,0.008) 100%), var(--pattern), var(--noise); background-attachment: fixed; color: var(--text-main); overflow-x: hidden; box-shadow: inset 0 0 200px rgba(212,175,55,0.02); }
        a { text-decoration: none; color: inherit; } 
        button { cursor: pointer; border: none; font-family: 'Crimson Text', serif; }

        /* NAV */
        nav { position: fixed; top: 0; width: 100%; padding: 20px 5%; display: flex; justify-content: space-between; align-items: center; background: var(--glass); backdrop-filter: blur(20px); z-index: 1000; border-bottom: 1px solid var(--border); }
        .logo { font-family: 'Italiana', serif; font-weight: 400; font-size: 1.6rem; letter-spacing: 2px; color: var(--text-main); text-shadow: 0 0 20px rgba(212, 175, 55, 0.5); }
        ...
        .cart-count { position: absolute; top: -2px; right: -2px; background: var(--accent); color: #000; font-size: 0.7rem; font-weight: 700; width: 18px; height: 18px; border-radius: 50%; display: flex; justify-content: center; align-items: center; }
        ...
        .card { background: var(--bg-card); border-radius: 20px; overflow: hidden; border: 1px solid var(--border); }
        ...
        .c-title { font-family: 'Cinzel', serif; font-size: 1.3rem; margin-bottom: 5px; }
        .c-price { font-weight: 600; font-size: 1.1rem; color: var(--accent); display: block; margin-bottom: 15px;}
        .c-desc { color: var(--text-sub); font-size: 0.85rem; line-height: 1.5; margin-bottom: 20px; }
        ...
        .cart-title { font-family: 'Cinzel', serif; font-size: 1.5rem; letter-spacing: 1px; }
        .close-cart { font-size: 1.2rem; cursor: pointer; color: var(--text-sub); }
...
<body>
    ...
    <header>
        <img src="" class="hero-bg" id="hero-bg">
        <h1 id="page-title">...</h1>
